...
namespace IS_1_19_AlievRK
{
    public partial class Form2 : Form
    {
        ...
        class CPU<T> : accessories<T>
        {
            ...
            {
                lb.Items.Add($"Артикул:{artikul}, Год выпуска:{realese}, Цена:{price}, Частота процессора:{CPUfrequency}, Количество ядер:{core}, Количество потоков:{numbertheards}");
            }
        ...
        class Videocard<T> : accessories<T>
        {
            ...
            public override void DisplayInfo(ListBox lb)
            {
                lb.Items.Add($"Артикул:{artikul}, Год выпуска:{realese}, Цена:{price}, Частота GPU:{GPUfrequency}, Производитель:{manufacturer}, Количество потоков:{numbertheards}");
